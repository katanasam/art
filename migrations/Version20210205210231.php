 ...
 */
final class Version20210205210231 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE image (id INT AUTO_INCREMENT NOT NULL, post_id INT DEFAULT NULL, image_name VARCHAR(255) NOT NULL, type_content VARCHAR(50) NOT NULL, location VARCHAR(255) DEFAULT NULL, INDEX IDX_C53D045F4B89032C (post_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
